...
PIONEER_COMMANDS = {
    ...
    "set_amp_speaker_mode": {Zone.Z1: ["SPK", "SPK"], "args": [SpeakerModes]},
    "query_amp_hdmi_out": {Zone.Z1: ["?HO", "HO"]},
    "set_amp_hdmi_out": {Zone.Z1: ["HO", "HO"], "args": [HdmiOutModes]},
    "query_amp_hdmi3_out": {Zone.Z1: ["?HDO", "HDO"]},
    "set_amp_hdmi3_out": {Zone.Z1: ["HDO", "HDO"], "args": [Hdmi3OutModes]},
    "query_amp_hdmi_audio": {Zone.Z1: ["?HA", "HA"]},
    "set_amp_hdmi_audio": {Zone.Z1: ["HA", "HA"], "args": [HdmiAudioModes]},
    "query_amp_pqls": {Zone.Z1: ["?PQ", "PQ"]},
    "set_amp_pqls": {Zone.Z1: ["PQ", "PQ"], "args": [PqlsModes]},
    "set_amp_dimmer": {Zone.Z1: ["SAA", "SAA"], "args": [DimmerModes]},
    ...
    "set_amp_mode": {Zone.Z1: ["SAC", "SAC"], "args": [AmpModes]},
